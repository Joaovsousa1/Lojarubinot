...
const CUSTOM_OUTFITS = [
  // Type IDs confirmados na tabela oficial de outfits do wiki.rubinot.com (api/outfit-proxy)
  wp('Demonic Kid',                        2502),
  ...
  wp('Frostbringer',                       2604),
  wp('Flamebringer',                       2606),
  // Ainda sem imagem confirmada na tabela oficial de outfits do wiki.rubinot.com
